...
var _usefulImageMap = require("../../UsefulImageMap");
var _usefulImageMapDefault = parcelHelpers.interopDefault(_usefulImageMap);
document.documentElement.classList.remove("no-js");
document.documentElement.classList.add("js");
let image = document.querySelector("#map-image");
new (0, _usefulImageMapDefault.default)(image);

},{"../../UsefulImageMap":"4lzyt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4lzyt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
 ...
 */ class UsefulImageMap {
     ...
     */ renderAreas() {
        ...
        for (let area of this.areas)this.imageMap.appendChild(this._createAreaElement(area));
    }
    /**
     ...
     */ _createAreaElement(obj) {
        ...
        for (let key of Object.keys(obj.attributes))el[key] = obj.attributes[key];
        if (this.scale !== 1) el.coords = this._getScaledCoords(obj);
        return el;
    }
    /**
     ...
     */ _createAreaObjectCoords(obj) {
        ...
        switch(obj.attributes.shape){
            ...
            case "poly":
                coords = [];
                for(let i = 0; i < arrCoords.length; i = i + 2)coords.push({
                    x: arrCoords[i],
                    y: arrCoords[i + 1]
                });
                break;
     ...
     */ _getScaledCoords(obj) {
        ...
        switch(obj.attributes.shape){
            ...
            case "poly":
                ...
                break;
            case "circle":
                for (let item1 of obj.coords){
                    arr.push(Math.round(item1.x * this.scale));
                    arr.push(Math.round(item1.y * this.scale));
                    arr.push(Math.round(item1.r * this.scale));
                }
                coords = arr.join(",");
                break;
            default:
...
exports.default = UsefulImageMap;
...
},{}]},["9Zwzb","goJYj"], "goJYj", "parcelRequirec123")
